var procesoFisico = {
    ...
    cargaDatos:function () {
        $(document).ready( function () {
            $('#dt_proveedor').DataTable( {
                ...
                ajax: {
                    url: baseUrl + "/controlactivos/index/obtener-json-catalogo/tipoCatalogo/ESTADO_FISICO",
                    dataSrc: 'data'
                },
                columns: [
                ...
                , submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            procesoFisico.metodoMensaje(data, 'btnRegistrar');
                        }
                    });
                },
    ...
    procesoMuestra: function () {
        $(document).on("click", ".btnAccionEdit", function () {
            ...
            procesoFisico.funtCerrarReload();
    ...
    metodoMensaje: function (data, bonton) {
        ...
        if (result['valida'] == 1) {
            ...
            var respHtml = str.replace("i_mensaje", procesoFisico.mensajeExito01);
