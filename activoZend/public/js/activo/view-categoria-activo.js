var procesoCategoriaActivo = {
    ...
    cargaDatos:function () {
        $(document).ready( function () {
            $('#dt_proveedor').DataTable( {
                ...
                ajax: {
                    url: baseUrl + "/controlactivos/index/obtener-json-catalogo/tipoCatalogo/CATEGORIA_ACTIVO",
                    dataSrc: 'data'
                },
                columns: [
                ...
                , submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            procesoCategoriaActivo.metodoMensaje(data, 'btnRegistrar');
                        }
                    });
                },
    ...
    procesoMuestra: function () {
        $(document).on("click", ".btnAccionEdit", function () {
            ...
            procesoCategoriaActivo.funtCerrarReload();
    ...
    metodoMensaje: function (data, bonton) {
        ...
        if (result['valida'] == 1) {
            ...
            var respHtml = str.replace("i_mensaje", procesoCategoriaActivo.mensajeExito01);
