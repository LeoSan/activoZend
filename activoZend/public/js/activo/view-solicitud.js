var procesarSolicitud = {
    ...
    init: function () {
        ...
        procesarSolicitud.validaDeshabilitar();
            ...
            $("#formSolicitud").validate({
                ...
                , submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        data: datosForm,
                        success: function (data) {
                            procesarSolicitud.metodoMensaje(data, 'btnRegistrar');
                        }
                    });
                },
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (result['valida'] == 1) {
                                ...
                                var respHtml = str.replace("i_mensaje", procesarSolicitud.mensajeExito02);
    ...
    validaDeshabilitar: function () {
        $(document).on("click", ".btnAccionDel", function () {
            ...
            procesarSolicitud.modalMensaje('Confirmación', '¿ Está seguro de deshabilitar ?', id, 'btnAccionDel');
    ...
    metodoMensaje: function (data, bonton) {
        ...
        if (result['valida'] == 1) {
            var str = procesarSolicitud.EstruturaMesajeExito;
            var respHtml = str.replace("i_mensaje", procesarSolicitud.mensajeExito01);
