...
class  Pendum_Db_MatrixDb
{
	...
	{
		$oracleConfig = Zend_Registry::get('matrixdb')->params->toArray();
//		var_dump($oracleConfig);
	...
	public function query($query = 'null')
	{
		try {
        	$conn = $this->connect();
        	//$query = "SELECT * FROM PENDUPM.CTMENUARCHIVO WHERE IDPADRE=1";
